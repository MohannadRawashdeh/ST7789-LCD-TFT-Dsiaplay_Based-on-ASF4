...
void system_init(void)
{
	...
	gpio_set_pin_level(SPI_display_CSX,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(SPI_display_CSX, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(SPI_display_CSX, GPIO_PIN_FUNCTION_OFF);
